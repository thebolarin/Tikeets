...
const clientConfig = {
  host: process.env.TICKEET_REDIS_HOST,
  port: process.env.TICKEET_REDIS_PORT,
};

if (process.env.TICKEET_REDIS_PASSWORD !== 'null') {
  clientConfig.password = process.env.TICKEET_REDIS_PASSWORD;
}
